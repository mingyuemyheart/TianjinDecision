...
public class XiangJiManager {
	 ...
	 * @return
	 */
	public static final String getXJHourFore(double lng, double lat, String start, String end, long timestamp) {
		StringBuffer buffer = new StringBuffer();
		buffer.append("http://openapi.mlogcn.com:8000/api/aqi/fc/coor/");
	 ...
	 * @return
	 */
	public static final String getXJDayFore(double lng, double lat, String start, String end, long timestamp) {
		StringBuffer buffer = new StringBuffer();
		buffer.append("http://openapi.mlogcn.com:8000/api/aqi/fc/coor/");
		buffer.append(lng).append("/").append(lat);
		buffer.append("/d/");
