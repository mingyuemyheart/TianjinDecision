...
public class WarningDto implements Parcelable{
	...
	public String cityName2 = null;//城市名称
	...
	//一周预报信息
	public List<WeatherDto> foreList = new ArrayList<WeatherDto>();
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeString(this.cityName2);
	...
	protected WarningDto(Parcel in) {
		...
		this.foreList = new ArrayList<WeatherDto>();
